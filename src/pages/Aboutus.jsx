...
<section className="relative py-20 overflow-hidden bg-white">
    <div className="container mx-auto bg-violet-300 justify-center text-center px-4">
<p className="xl:font-medium bg tracking-wide mb-4 text-center mt-5 text-2xl lg:text-3xl font-normal text-blue-500 ">
LEADERSHIP</p>
        <h2 className=" mt-5 mb-10 text-4xl font-semibold leading-tight lg:text-5xl">An incredible team of <br/>amazing individuals</h2>
    </div>
